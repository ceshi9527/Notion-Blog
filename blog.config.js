...
const BLOG = {
  ...
  GREETING_WORDS: process.env.NEXT_PUBLIC_GREETING_WORDS || '我是一个打工人,欢迎来到我的博客🎉',

  CUSTOM_MENU: process.env.NEXT_PUBLIC_CUSTOM_MENU || false, // 支持Menu 类型，从3.12.0版本起，各主题将逐步支持灵活的二级菜单配置，替代了原来的Page类型，此配置是试验功能、默认关闭。

  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '9527', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一个普通的打工人🍚', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://google.com', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '谷歌, 博客', // 网站关键词 英文逗号隔开
  ...
  POSTS_SHARE_SERVICES: process.env.NEXT_PUBLIC_POST_SHARE_SERVICES || 'email,telegram', // 分享的服務，按顺序显示,逗号隔开
  ...
  PREVIEW_TAG_COUNT: 6, // 首页最多展示的标签数量，0为不限制
